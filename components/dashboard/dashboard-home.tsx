...
import { ClipboardCheck, FileText, Users, TrendingUp, Calendar, BookOpen, PlusCircle } from "lucide-react"

export function DashboardHome() {
  return (
    <div className="space-y-6">
      <div className="text-center sm:text-left">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Bienvenido al Portal Académico</h2>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs sm:text-sm font-medium">Secuencias Pendientes</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs sm:text-sm font-medium">POAs Activos</CardTitle>
            <FileText className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-xl sm:text-2xl font-bold">8</div>
            <p className="text-xs text-muted-foreground">Para el ciclo 2025-A</p>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs sm:text-sm font-medium">Docentes Activos</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xs sm:text-sm font-medium">Eficiencia</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          ...
          <CardContent>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Secuencias pendientes</span>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-sm">Formulario para crear nuevas secuencias didácticas</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Borradores guardados</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-sm">Últimas acciones realizadas en el sistema</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">Secuencia "Álgebra Lineal" aprobada</p>
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">POA "Matemáticas 2025-A" actualizado</p>
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">Nueva secuencia enviada para revisión</p>
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium truncate">Secuencia "Física Cuántica" creada</p>
